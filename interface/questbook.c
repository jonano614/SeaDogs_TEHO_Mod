...
void ShowInfoWindow() // belamour int index не нужен тут
{
	...
	switch (sCurrentNode)
	{
		...
		//belamour окно инфы
		case "TABLE_SHIP_PLACE":
				sHeader = "Корабли на приколе";
				sText1 = "Здесь хранится информация о кораблях на стоянке, место их нахождения, вахтенный офицер, дата постановки, а так же величина портовых сборов и тарифов"; 
				sText2 =  "Нажмите ЛЕВУЮ КНОПКУ МЫШИ для получения информации о корабле";
				sText2 = sText2 + newStr() + "Нажмите CTRL и ЛЕВУЮ КНОПКУ МЫШИ для получения информации о вахтенном офицере";
				CreateTooltip("#" + sHeader, sText1, argb(255,255,255,255), sText2, argb(255,255,192,192), sText3, argb(255,192,255,192), "", argb(255,255,255,255), sPicture, sGroup, sGroupPicture, 64, 64);
		break;
	}
