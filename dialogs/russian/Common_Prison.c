...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First_officer":
			...
			{
				link.l13 = "Хотел поговорить с вами об одном человеке по имени " + PChar.GenQuest.JusticeOnSale.SmugglerName + ". Если не ошибаюсь – он ваш заключённый."; // belamour gen
